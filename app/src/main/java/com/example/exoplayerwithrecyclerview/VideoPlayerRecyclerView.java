...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    private void playVideo(boolean isEndOfList) {
        ...
        if (!isEndOfList){
            ...
            // if there is more than 2 listitlems on the screen
            ...
            // if there is more than 1 listitem on the screen
        ...
        DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(
                context, Util.getUserAgent(context, "ExoPlayerWithRecyclerView"));
